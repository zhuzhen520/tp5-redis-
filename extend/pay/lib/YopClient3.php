...
class YopClient3
{
    ...
    static public function handleRsaResult($YopRequest, $YopResponse, $content)
    {
    ...
    static private function getBizResult($content, $format)
    {
        if (empty($format)) {
            return $content;
        }
    ...
    static private function uuid($prefix = '')
    {
